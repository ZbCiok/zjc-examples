...
```
mvn clean package
java -jar target/vertx-verticle-example-01-1.0-SNAPSHOT.jar
```

#### Sample output 

==================================================
=== SampleVerticle listening on localhost:8080 ===
==================================================
Nov 21, 2023 7:13:56 PM io.vertx.core.impl.launcher.commands.VertxIsolatedDeployer
